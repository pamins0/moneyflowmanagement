...
<div class="form-group col-sm-3 w10">
	...
	<form:select path="hierarchyControl.orgManagement.orgType.id"
	...
	<div class="has-error">
		<form:errors path="hierarchyControl.orgManagement.orgType.id"
...
<div class="form-group col-sm-3 w10">
	...
	<form:select path="hierarchyControl.orgManagement.id"
		cssClass="form-control" id="orgManagementId" onchange="changeBranchManagement()">
		<form:option value="-1" label="- OrgManagement -" />
		<form:options items="${orgManagementSet}" itemValue="id"
			itemLabel="name" />
	</form:select>
	<div class="has-error">
		<form:errors path="hierarchyControl.orgManagement.id"
			cssClass="help-inline" />
	</div>
</div>
</div>
...
<div class="form-group col-sm-3 w10">
	...
	<div class="col-sm-12">
							<div class="input-group">
									<span class="input-group-addon"><i class="mandatory-star">*</i></span>
