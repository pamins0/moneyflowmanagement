...
<section class="content-header">
	<h1>Bid Placed Vs Accepted Report</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12 table-container-main">
			<div class="box-header">
				<div class="heading-title-wrapper">
					...
					<section class="content">
						<div class="row">
							<form:form action="bidsPlacedVsAcceptedReport" id="NewEditForm"
						...
						<table class="table table-bordered table-striped"
							...
							<thead>
								<tr class="info">
									...
									<th><fmt:message key="Report.list.totalPlacedBids" /></th>
									<th><fmt:message key="Report.list.totalAcceptedBids" /></th>
								</tr>
							</thead>
							...
							<tbody>
								...
								<tr>
									...
									<td><small>${totalPlacedBids}</small></td>
									<td><small>${totalAcceptedBids}</small>
								</tr>
								<%-- </c:forEach> --%>
							</tbody>
						</table>
