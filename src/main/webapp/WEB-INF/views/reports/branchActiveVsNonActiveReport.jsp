...
<section class="content-header">
	<h1>Branch Active/Non Active</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12 table-container-main">
			<div class="box-header">
				<div class="heading-title-wrapper">
					...
					<h3 class="box-title">Branch Active/Non Active</h3>
					<section class="content">
						<div class="row">
							<form:form action="branchActiveVsNonActiveReport"
								id="NewEditForm" method="POST" modelAttribute="user"
