...
<section class="content-header">
	<h1>Branch Cash Denomination Report</h1>
	<ol class="breadcrumb">
		...
		<div class="col-md-12 table-container-main">
			<div class="box-header">
				<div class="heading-title-wrapper">
					...
					<section class="content">
						<div class="row">
							<form:form action="branchCashDenominationReport" id="NewEditForm"
								...
								<tbody>
									...
									<c:forEach items="${auditTrials}" var="branch" varStatus="counter"> 
										<tr>											
											...
											<td><small><fmt:formatDate value="${branch.createdTime}" pattern="${pattern}"/></small></td>
											<td><small>${branch.branchManagement.branchName}</small></td>
											<td><small>${branch.branchParameter.parameterName}</small></td>
											<%-- <td><small><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${branch.total}"/></small> --%>
											<td><small>
