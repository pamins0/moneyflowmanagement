...
/**
 * The persistent class for the place_cash_Request database table.
 * 
 */
@Entity
@Table(name = "place_cash_Request")
@NamedQuery(name = "PlaceCashRequest.findAll", query = "SELECT p FROM PlaceCashRequest p")
public class PlaceCashRequest implements Serializable {
